...
| Windows 11 x64 原生版 | [原生版发布列表](https://github.com/lyq2010/building-panel-dept-toolkit-releases/releases?q=windows-native-v) | `packing-list-toolkit_*_windows-native-x64-setup.exe` |
