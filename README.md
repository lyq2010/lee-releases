...
- Lee's Toolbox Windows 使用 WinUI 3，仅支持 Windows 11 22H2 及以上；开始菜单名称为「Lee's 工具箱 Windows」。
- macOS 通用版使用 Tauri；macOS 原生版为「Lee‘s工具箱 Mac」（Lee’s Toolbox Mac），使用 SwiftUI，仅支持 Apple Silicon。
