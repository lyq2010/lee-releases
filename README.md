...
| 产品 | 适用系统 | 下载入口 | 安装文件 |
|---|---|---|---|
| Windows&nbsp;通用版 | Windows&nbsp;x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/latest) | `*_x64-setup.exe` |
| Lee's&nbsp;Toolbox&nbsp;Windows | Win&nbsp;11&nbsp;22H2+&nbsp;x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases?q=lees-toolbox-windows-v&expanded=true) | `*_x64-setup.exe` |
| macOS&nbsp;通用版 | Apple&nbsp;Silicon | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/latest) | `*_arm64.dmg` |
| Lee’s&nbsp;Toolbox&nbsp;Mac | Apple&nbsp;Silicon | [最新稳定版](https://github.com/lyq2010/lee-releases/releases?q=native-v&expanded=true) | `*_arm64.dmg` |
| Lee's&nbsp;Mail | Win&nbsp;11&nbsp;22H2+&nbsp;x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases?q=lees-mail-v&expanded=true) | `*_x64.msix` |
...
Lee's Mail 使用个人证书签名的 MSIX：先把同一 Release 中的
`LeesMail_CN-Lee.cer` 导入“受信任人”证书存储，再安装 `LeesMail_*_x64.msix`。
Release 同时附带 SHA-256、版本清单和 GPL 对应源码归档。
