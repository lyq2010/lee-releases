...
| Lee's Toolbox Windows | Windows 11 22H2 及以上 x64 | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/tag/lees-toolbox-windows-v1.0.7) | `lees-toolbox-windows_*_x64-setup.exe` |
| macOS 通用版 | Apple Silicon | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/latest) | `packing-list-toolkit_*_arm64.dmg` |
| Lee’s Toolbox Mac | Apple Silicon | [最新稳定版](https://github.com/lyq2010/lee-releases/releases/tag/native-v3.0.9) | `Lee’s Toolbox Mac_*_macOS_arm64.dmg` |
